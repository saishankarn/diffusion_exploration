...
class VAEConfig():
    def __init__(self):
        ...
        self.pretrained_loc = 'save/sine_20230818_052027/results/model_best.pth'

# class UnconditionalLDMConfig():
#     def __init__(self):
#         # train config parameters
#         self.train_batch_size = 64
#         self.val_batch_size = 64
...
#         self.n_features = 1
#         self.diffusion_step_embedding_dim = 96
#         self.latent_dim = 96
#         self.dim_val = 128
#         self.dropout_pos_enc = 0.2 
#         self.max_seq_len = 16
#         self.n_heads = 8
#         self.n_denoising_layers = 4
#         self.batch_first = True
#         self.channels = 64
