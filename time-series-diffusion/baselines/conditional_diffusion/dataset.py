...
class GetDataset(Dataset):
    def __init__(self, dataset_config, train=True):
        ...
        if train:
            self.dataset = sine_dataset_obj.train_data
            self.labels = sine_dataset_obj.train_labels
        else:
            self.dataset = sine_dataset_obj.test_data 
            self.labels = sine_dataset_obj.test_labels
