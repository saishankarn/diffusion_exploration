...
class PM25_Dataset(Dataset):
    def __init__(self, eval_length=48, target_dim=36, mode="train", validindex=0):
        self.eval_length = eval_length
        self.target_dim = target_dim

        path = "../../datasets/pm25/pm25_meanstd.pk"
        ...
        df = pd.read_csv(
            "../../datasets/pm25/Code/STMVL/SampleData/pm25_ground.txt",
            index_col="datetime",
            parse_dates=True,
        )
        df_gt = pd.read_csv(
            "../../datasets/pm25/Code/STMVL/SampleData/pm25_missing.txt",
            index_col="datetime",
            parse_dates=True,
        )
